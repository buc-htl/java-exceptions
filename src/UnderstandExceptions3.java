 ...
 * <p>
 * Da unchecked Exceptions (alle Subklassen von RuntimeException) nicht behandelt werden müssen,
 * können sie bei "throws" angegeben werden, müssen aber nicht.
 * Checked Exceptions müssen angegeben werden wenn man möchte, dass sie weiter geworfen werden.
 *
  */
public class UnderstandExceptions3 {
    ...
    public static void run() {
        ...
        /* doSomething() kann eine ArrayIndexOutOfBoundsException "weiter werfen".
           Wir fangen sie an dieser Stelle mit einem try-catch Block.
           Alternativ könnte die run()-Methode ebenfalls die Exception weiter werfen.
        */
        try {
            doSomething();
            doSomethingElse();
